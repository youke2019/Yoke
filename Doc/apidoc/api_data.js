define({ "api": [
  {
    "type": "get",
    "url": "/courses/answers/findById",
    "title": "",
    "name": "findAnswerById",
    "group": "CourseAnswer",
    "description": "<p>通过ID查找课程问题回答</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  {
    "type": "get",
    "url": "/courses/comments/findById",
    "title": "",
    "name": "findCommentById",
    "group": "CourseComment",
    "description": "<p>通过ID查找课程评论（无回复）</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  {
    "type": "get",
    "url": "/courses/moments/findById",
    "title": "",
    "name": "findMomentById",
    "group": "CourseMoment",
    "description": "<p>通过ID查找课程精彩瞬间（无回复）</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  {
    "type": "get",
    "url": "/courses/questions/findById",
    "title": "",
    "name": "findQuestionById",
    "group": "CourseQuestion",
    "description": "<p>通过ID查找课程问题（无回答）</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
